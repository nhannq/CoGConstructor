...
public class HadoopDataflowConstructor extends GraphBuilderAbstract {
  ...
  public void constructDataflow() {
    ...
    String optionSource = "<org.apache.hadoop.conf.Configuration: int getInt(java.lang.String,int)>";
    String optionSink = "";
